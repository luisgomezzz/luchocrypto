                ...
                try:
                    ...
                    try:   
                        ...
                        if ((precioactual - preciomenor)*(100/preciomenor))>=porcentaje and (precioactual>=preciomayor) and float(volumen24h)>=float(1):
                            ...
                            print("paso1")     
                            mensaje=par+" up "+str(round(((precioactual - preciomenor)*(100/preciomenor)),2))+"% - "+str(ventana)+" minutes. RSI14: "+str(truncate(rsi14(client,par),2))+". Price:"+str(precioactual)
                        ...
                        if ((preciomenor - precioactual)*(100/preciomenor))>=porcentaje and (precioactual<=preciomenor) and float(volumen24h)>=float(1):
                            ...
                            #input("Press Enter to continue...")     
                            print("paso2")
                            mensaje=par+" down "+str(round(((preciomenor - precioactual)*(100/preciomenor)),2))+"% - "+str(ventana)+" minutes. RSI14: "+str(truncate(rsi14(client,par),2))+". Price:"+str(precioactual)
                            botlaburo.send_text(mensaje)
                            botamigos.send_text(mensaje)
                            dibujo(par)
