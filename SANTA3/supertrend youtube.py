...
df['entry'] = np.nan
df['entry'] = np.where((df.resta.shift(1) < 0) & (df.rsi21.shift(1) < 66) & (df.rsi3.shift(1) > 80) & (df.rsi28.shift(1) > 49) & (df.sig.shift(1) > 20), "long", np.where((df.resta.shift(1) > 0) & (df.rsi21.shift(1) > 34) & (df.rsi3.shift(1) < 20) & (df.rsi28.shift(1) < 51) & (df.sig.shift(1) > 20),"short",np.nan))
